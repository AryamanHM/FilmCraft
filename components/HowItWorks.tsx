      ...
      <View style={styles.section}>
        ...
        <View style={styles.step}>
          <View style={styles.stepContent}>
            ...
            <Image source={require("../assets/images/react-logo.png")} style={styles.stepImage} resizeMode="contain" />
          </View>
          <View style={styles.lifebuoy}>
            <Image source={require("../assets/images/react-logo.png")} style={styles.lifebuoyImage} resizeMode="contain" />
          </View>
        </View>
